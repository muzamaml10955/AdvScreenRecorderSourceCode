...
public class Const {
    ...
    public static final String SCREEN_RECORDING_START = "com.coolapps.screenrecorder.services.action.startrecording";
    public static final String SCREEN_RECORDING_PAUSE = "com.coolapps.screenrecorder.services.action.pauserecording";
    public static final String SCREEN_RECORDING_RESUME = "com.coolapps.screenrecorder.services.action.resumerecording";
    public static final String SCREEN_RECORDING_STOP = "com.coolapps.screenrecorder.services.action.stoprecording";
    public static final String SCREEN_RECORDING_DESTORY_SHAKE_GESTURE = "com.coolapps.screenrecorder.services.action.destoryshakegesture";
    public static final String SCREEN_RECORDER_VIDEOS_LIST_FRAGMENT_INTENT = "com.coolapps.screenrecorder.SHOWVIDEOSLIST";
